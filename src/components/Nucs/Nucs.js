  ...
  return (
    <PageWrapper announcement="Spring 2026 Nucs · Limited Availability · Reserve Yours" announcementLink="/nucs">
      <SEO
        ...
        description="Pre-order 5-frame honeybee nucs for spring 2026. Locally adapted queens, $190 + refundable box deposit. Pickup in Vestal, NY. Limited availability."
        path="/nucs"
        image="/assets/nucs/nucsFrame.jpg"
      >
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "A ready-to-go 5-frame nucleus colony from Irek's Apiary in Vestal, NY. Locally adapted queen. Available for pickup spring 2026. Serving the Binghamton, Southern Tier, and Upstate New York area.",
      ...
      <HeroGrid>
        ...
        <PurchaseCol>
          ...
          <Description>
            ...
            healthy brood and enough stores to hit the ground
          ...
          <BulkLink to="/nucs/bulk">Need 5 or more? Order in bulk here.</BulkLink>
        </PurchaseCol>
      </HeroGrid>

      <StorySection>
        <SectionTitle>Our Bees</SectionTitle>
        <StoryTag>14 years and counting.</StoryTag>
        <StoryProse>
          We've been keeping bees since 2012. Our colonies were inherited from a
          beekeeper who spent over 35 years working hives in the Southern Tier.
          Same bees, same genetics, passed down and cared for across generations.
        </StoryProse>
        <StoryProse>
        ...
        <StoryProse>
          When you get a nuc from us, you're getting a colony with roots in this
          area.
        </StoryProse>
      </StorySection>
